...
exports.addProduct =[
  ...
  body('product_description').isLength({min:20}).withMessage('Product description must be at least 20 chars').isLength({max:2000}).withMessage('Product description must not exceed 2000 chars').exists().withMessage('Product Description is required.'),
  body('product_specs').isLength({min:20}).withMessage('Product specs must be at least 20 char').isLength({max:2000}).withMessage('Product specs must not exceed 2000 chars').exists().withMessage('Product specs is required.'),
  (req, res,next) => {
